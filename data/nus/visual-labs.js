(function () {
  ...
  window.NUS_VISUAL_LABS = {
    "dsa5105-erm": {
      ...
      initialState: { complexity: 42 }, explanation: "The useful choice is near the lowest validation risk, not necessarily the lowest training risk."
    },
    "dsa5105-svm-margin": {
      ...
      initialState: { margin: 2 }, explanation: "Support vectors anchor the boundary; changing the margin changes the trade-off between fit and robustness."
    },
    "dsa5105-pca-deep-dive": {
      ...
      initialState: { step: 0 }, explanation: "PCA is a sequence: remove the mean, find high-variance directions, then represent data in that basis."
    },
    "dsa5105-cluster-gmm": {
      ...
      initialState: { step: 0 }, explanation: "EM alternates an expectation step with a maximization step; each update is conditional on the other."
    },
    "dsa5105-rl-bellman": {
      ...
      initialState: { step: 0 }, explanation: "A Bellman backup turns a long return into local evidence plus a discounted estimate of what follows."
    },
    "dsa5105-gnn": {
      ...
      initialState: { step: 0 }, explanation: "The graph layer is a pipeline: transform neighbors, aggregate the set, then combine with the node state."
    }
  };
})();
