(function () {
  ...
  function course(code) { return repository() ? repository().getCourse(code) : null; }
  ...
  function lesson(code, id) { return repository() ? repository().getLesson(code, id) : null; }
