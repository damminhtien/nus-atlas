(function () {
  ...
  function renderLesson(code, id) {
    ...
    body += studyCompass(l);
    const lab = window.NUS_VISUAL_LABS && window.NUS_VISUAL_LABS[l.id];
