...
(function (root, factory) {
  ...
  function render(courseCode, rawPage) {
    ...
    body += `${readingTimer && typeof readingTimer.render === "function" ? readingTimer.render(id) : ""}<div class="nus-lesson-actions">${button("← Course", `#/nus/course/${course.code}`, "ghost")}${courseCode === "DSA5105" ? `${button("Week 1 slides", "#/nus/slides/DSA5105/dsa5105-week1-annotated/1", "ghost")}${button("Week 2 slides", "#/nus/slides/DSA5105/dsa5105-week2-annotated/1", "ghost")}` : ""}<span class="nus-textbook-reader-hint"><kbd>←</kbd><kbd>→</kbd> or <kbd>J</kbd><kbd>K</kbd> change page</span></div>`;
