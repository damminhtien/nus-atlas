...
(function (root, factory) {
  ...
  function cardLink(courseCode, question, label = "Study this card") {
    return question && question.lessonId && question.cardId
      ? button(label, `#/nus/lesson/${esc(courseCode)}/${esc(question.lessonId)}/${esc(question.cardId)}`, "ghost")
      : "";
  }

  function setup(input) {
    const { courses, selectedCode, courseCode, scope, lessons, practicePlan } = input;
